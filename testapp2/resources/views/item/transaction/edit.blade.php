...
<head>
    ...
    <title>Clinic: Edit Transaction</title>
    ...
    <div class="container-fluid" style="padding-top: 15px;">
        <div class="row">
            <div class="col-md-12 rounded-background">
                <div class="d-md-none">
                    <a type="button" class="btn item-btn d-flex justify-content-between align-items-center" href="{{ route('item.transaction.show', [$item->id, $transaction->id]) }}" style="width: 8em">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-none d-md-inline">
                        <a type="button" class="btn item-btn d-flex justify-content-between align-items-center" href="{{ route('item.transaction.show', [$item->id, $transaction->id]) }}">
                            <i class="bi-arrow-left" style="font-size:2em;line-height:1em"></i>
                            <h4 style="margin:0">BACK</h4>
                        </a>
                    </div>
