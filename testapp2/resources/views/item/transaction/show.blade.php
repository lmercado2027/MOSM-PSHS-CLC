...
<head>
    ...
    <title>Clinic: Show Transaction</title>
    ...
    <div class="container-fluid" style="padding-top: 15px;">
        <div class="row">
            <div class="col-md-12 rounded-background">
                <div class="d-md-none">
                    <a type="button" class="btn item-btn d-flex justify-content-between align-items-center" href="{{ route('item.transaction.index', $item->id) }}" style="width: 8em">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-none d-md-inline">
                        <a type="button" class="btn item-btn d-flex justify-content-between align-items-center" href="{{ route('item.transaction.index', $item->id) }}">
                            <i class="bi-arrow-left" style="font-size:2em;line-height:1em"></i>
                            <h4 style="margin:0">BACK</h4>
                        </a>
                    </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-none d-md-flex flex-column align-items-end">
                        ...
                        <br>
                        <form action="{{ route('item.transaction.destroy', [$item->id, $transaction->id]) }}" method="post">
                            @csrf
                            @method('DELETE')
